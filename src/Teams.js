...
const rawTeams = [
    {
        ...
        stats: {
            opPerWeek: [12, 14, 11, 8, 10, 11, 10, 5, 14, 12, 15, 13, 13, 13, 20, 9, 16, 21, 16, 19],
            pfPerWeek: [1, 1, 2, 1, 2, 3, 3, 2, 1, 2, 2, 3, 2, 2, 2, 2, 2, 1, 2, 2],
            opponentPerWeek: [1],
            oppfPerWeek: [6, 3, 6, 1, 2, 2, 2, 2, 3, 6, 15, 7, 2, 2, 8, 0, 10, 9, 5, 7],
            totalOP: 500
        },
        playerList: {
            hitters: {
    ...
    },
    {
        ...
        stats: {
            opPerWeek: [9, 10, 10, 15, 10, 12, 10, 15, 13, 9, 18, 14, 13, 15, 14, 17, 15, 15, 13, 15],
            pfPerWeek: [1, 2, 2, 2, 2, 2, 1, 0, 2, 1, 0, 1, 3, 2, 2, 3, 1, 2, 1, 2],
            opponentPerWeek: [0],
            oppfPerWeek: [4, 2, 4, 9, 1, 0, 4, 10, 8, 2, 7, 3, 1, 5, 5, 2, 9, 3, 4, 5],
            totalOP: 462
        },
        playerList: {
            hitters: {
